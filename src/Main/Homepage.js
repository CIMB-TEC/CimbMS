    ...
    <div>
      ...
      <SimpleGrid color="white" bg="grey" height="90vh">
        ...
        <Text width="30%">
          ...
          alumnos del Tecnológico de Monterrey en Campus Ciudad de México en el
          año 2009.
        </Text>
      </SimpleGrid>
      ...
      <SimpleGrid bg="grey" height="90vh">
        ...
        <Text color="white" width="30%">
          Nuestro grupo busca generar proyectos para la mejora de la calidad de
          vida de la sociedad mexicana y una mejora de la Experiencia del
          Usuario (UX) ante el uso de nuevas tecnologías. Él laboratorio trabaja
          a través de la generación de proyectos de Posgrados y Pregrado sobre
          las distintas líneas de investigación de enfoque.
        </Text>
      </SimpleGrid>
      {/*<BlogSlider />*/}
      <Footer />
