            ...
            <div className={styles.WaveContainer}>
                <div className={styles.ContentContainer}>
                    ...
                    <p className={styles.Description}>
                        Nuestro grupo busca generar proyectos para la mejora de la calidad de vida de la sociedad mexicana y una mejora
                        de la Experiencia del Usuario (UX) ante el uso de nuevas tecnologías. Él laboratorio trabaja a través de la generación de proyectos de
                        Posgrados y Pregrado sobre las distintas líneas de investigación de enfoque.
                    </p>
                </div>
            </div>
                ...
                <div className={styles.ContentContainer2}>
                    ...
                    <div className={styles.AreasContainer}>
                        ...
                        <div className={styles.AreaTwoContainer}>
                            ...
                            <AiOutlineFileSearch className={styles.Icon} />
                            <p className={styles.AreaTitle}> Sistemas avanzados de monitoreo y asiatencia al coductor </p>
            ...
            <div className={styles.WaveContainer3}>
                <div className={styles.ContentContainer3}>
                    ...
                    <figure className={styles.ImageContainerTeam}>
                        <img src={t1} alt="Juno's Latest Flyby of Jupiter Captures Two Massive Storms" />
                    </figure>

                    <figure className={styles.ImageContainer}>
                        <img src={c1} alt="Juno's Latest Flyby of Jupiter Captures Two Massive Storms" />
                    </figure>

                    <figure className={styles.ImageContainer}>
                        <img src={i6} alt="Juno's Latest Flyby of Jupiter Captures Two Massive Storms" />
                    </figure>



                    <figure className={styles.ImageContainer}>
                        <img src={c2} alt="Juno's Latest Flyby of Jupiter Captures Two Massive Storms" />
                    </figure>

                    <figure className={styles.ImageContainer}>
                        <img src={c4} alt="Juno's Latest Flyby of Jupiter Captures Two Massive Storms" />
                    </figure>
                    ...
                    <figure className={styles.ImageContainer}>
                        <img src={i1} alt="Juno's Latest Flyby of Jupiter Captures Two Massive Storms" />
                    </figure>


                    <figure className={styles.ImageContainer}>
                        <img src={i3} alt="Juno's Latest Flyby of Jupiter Captures Two Massive Storms" />
                    </figure>

                    <figure className={styles.ImageContainer}>
                        <img src={i2} alt="Juno's Latest Flyby of Jupiter Captures Two Massive Storms" />
                    </figure>

                    <figure className={styles.ImageContainer}>
                        <img src={i5} alt="Juno's Latest Flyby of Jupiter Captures Two Massive Storms" />
                    </figure>

                    <figure className={styles.ImageContainerLast}>
                        <img src={c5} alt="Juno's Latest Flyby of Jupiter Captures Two Massive Storms" />
                    </figure>

                    <figure className={styles.ImageContainerLast}>
                        <img src={c3} alt="Juno's Latest Flyby of Jupiter Captures Two Massive Storms" />
                    </figure>
