...
let strings = {
    title : "Plataforma para Vehículo Inteligente",
    description : 'El proyecto busca desarrollar una plataforma para un vehículo todo terreno, completamente eléctrico e instrumentado.',
    milestones : [
        {
            date: 'Enero 2016',
            images: [
